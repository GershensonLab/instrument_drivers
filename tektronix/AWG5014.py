...
#wsLu modified for AWG5208, was 'SOURce1:ROSCillator:SOURce?'
                           get_cmd='SOURce1:ROSCillator:MULTiplier?',
                           set_cmd='SOURce1:ROSCillator:MULXTiplier ' + '{}',
                           vals=vals.Enum('INT', 'EXT'),
                           get_parser=self.newlinestripper)
        ...
        self.add_parameter('event_impedance',
                           ...
                           unit='Ohm',
#wsLu modified for AWG5204, was 'EVENt:IMPedance?'
                           get_cmd='TRIGger:IMPedance?',
                           set_cmd='TRIGger:IMPedance ' + '{}',
                           vals=vals.Enum(50, 1000),
                           get_parser=float)
